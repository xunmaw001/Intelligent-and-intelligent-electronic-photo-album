...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    <el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"30px","background":"#a5f0e4","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"20px 7%","color":"#333","borderRadius":"20px","textAlign":"center","background":"#ceeff3","width":"86%","fontSize":"16px","lineHeight":"40px"}'>我的收藏</div>
