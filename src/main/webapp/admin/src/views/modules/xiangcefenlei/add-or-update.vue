<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"padding":"0px","boxShadow":"0px 0px 0px 0px #d2b3aa","margin":"0 0 20px 0","borderColor":"#d3a7be","borderRadius":"0px","background":"none","borderWidth":"0px","display":"block","width":"100%","minWidth":"500px","borderStyle":"solid"}' class="input" v-if="type!='info'"  label="相册分类" prop="xiangcefenlei">
					<el-input v-model="ruleForm.xiangcefenlei" placeholder="相册分类" clearable  :readonly="ro.xiangcefenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"0px","boxShadow":"0px 0px 0px 0px #d2b3aa","margin":"0 0 20px 0","borderColor":"#d3a7be","borderRadius":"0px","background":"none","borderWidth":"0px","display":"block","width":"100%","minWidth":"500px","borderStyle":"solid"}' v-else class="input" label="相册分类" prop="xiangcefenlei">
					<el-input v-model="ruleForm.xiangcefenlei" placeholder="相册分类" readonly></el-input>
				</el-form-item>
			</template>
